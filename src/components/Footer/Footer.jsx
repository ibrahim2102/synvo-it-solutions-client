            ...
            <footer className="footer p-10 bg-secondary text-neutral-content">
                <div className="flex flex-col lg:flex-row justify-between w-full">
                    ...
                    <div className="mb-6 lg:mb-0">
                        <h2 className="text-xl font-bold mb-2">Synvo</h2>
                        <p className="text-sm mb-4 max-w-xs">
                            A trusted platform to discover and offer professional services.
                        </p>
                        {/* Social Media Links */}
                    ...
                    <div className="mb-6 lg:mb-0 flex flex-col">
                        ...
                        <Link to='/services' className="link link-hover">IT Support</Link>
                    </div>

                    {/* Company Section */}
                    <div className="mb-6 lg:mb-0 flex flex-col">
                        <span className="footer-title">Company</span>
                        <Link to='/services' className="link link-hover">About</Link>
                        <Link to='/services' className="link link-hover">Careers</Link>
                        <Link to='/dashboard/profile' className="link link-hover">Contact</Link>
                    </div>
                ...
                {/* Copyright */}
                <div className="border-t border-secondary-content/20 pt-6 mt-6 text-center w-full">
                    <p className="text-sm">
                        © {new Date().getFullYear()} Synvo. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
